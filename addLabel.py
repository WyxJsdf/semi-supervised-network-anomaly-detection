...
def main():
    ...
    for i in range(4, 5):
        ...
        f = open(absolute_path+csvNames[5],"r")
        reader = csv.reader(f)
        labeled_list = list(reader)
        f = open(absolute_path+csvNames[6],"r")
        reader = csv.reader(f)
        labeled_list += list(reader)
